# Mojo Core metadata specifications 
...
## Maintainer[]{#maintainer-optional} {#core-metadata-maintainer}
...
See `508`{.interpreted-text role="pep"} for full details of the allowed
format.
